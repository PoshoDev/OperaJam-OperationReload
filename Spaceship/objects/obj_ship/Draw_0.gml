...
draw_sprite_ext(spr_ship_otto, otto_index, x+shdw, y+shdw, image_xscale, image_yscale, image_angle, c_black, 0.9);
draw_sprite_ext(sprite_index, image_index, x+shdw, y+shdw, image_xscale, image_yscale, image_angle, c_black, 0.9);
